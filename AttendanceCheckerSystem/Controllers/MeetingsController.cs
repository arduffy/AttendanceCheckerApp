...
namespace AttendanceCheckerSystem.Controllers
{
    public class MeetingsController : Controller
    {
        ...
        // GET: Meetings/AttendanceSummary/5
        public async Task<IActionResult> AttendanceSummary(int? id)
        {
            if (id == null)
            {
                return NotFound();
            ...
            //ViewData["MeetingInfo"] = student.MeetingDay.ToLongDateString();
            ...
            var model = _context.Meetings
                .Join(_context.AttendMeeting,
                      s => s.ID,
                      a => a.StudentID,
                      ((meeting, attend) => new AttendanceSummaryViewModel { Student = student, Attend = attend }))
